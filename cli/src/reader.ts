...
import { parseNumber, parseNumberArray } from "./schema/number.js";
import { parseBoolean } from "./schema/boolean.js";
import { parseISODate } from "./schema/date.js";
import { parseEnum } from "./schema/enum.js";
import { parseStringArray } from "./schema/string.js";
...
export function read<T>(argsMetadataT: T, argv?: string[]): T {
    const res: any = {};
